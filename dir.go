...
func dirHandler(w http.ResponseWriter, r *http.Request) {
	if r.URL.Path == "/favicon.ico" {
		http.Redirect(w, r, "/static/favicon.ico", http.StatusTemporaryRedirect)
		return
	}
	const base = "."
...
func showDir(n string) bool {
	if len(n) == 0 || n[0] == '.' || n == "js" || n == "static" || n == "templates" {
		return false
	}
	return true
}
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <title>Talks - Study Accumulation Share Dissemination</title>
...
<div id="topbar">
  <div class="container">
	<div id="heading"><a href="/">Talks - Study Accumulation Share Dissemination</a></div>
  </div>
 </div>
...
<p>
Talks modified from <a href="http://code.google.com/p/go.talks/present">go.talks/present</a>,
written by <a href="mailto:xuyu16@gmail.com">xuyu&lt;xuyu16@gmail.com&gt;</a>
</p>
